 ...
 */
package org.springside.modules.logback;
...
public interface ILoggingEventCache {
     ...
     * the events that were passed to {@link #put(ch.qos.logback.classic.spi.ILoggingEvent)}, they should be completely omitted from the event
     * list returned.
     *
