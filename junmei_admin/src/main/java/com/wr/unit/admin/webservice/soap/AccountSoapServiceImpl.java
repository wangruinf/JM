 ...
 *******************************************************************************/
package com.wr.unit.admin.webservice.soap;
...
import com.wr.unit.admin.service.AccountEffectiveService;

import com.wr.unit.admin.webservice.soap.response.GetTeamDetailResult;
import com.wr.unit.admin.webservice.soap.response.GetUserResult;
import com.wr.unit.admin.webservice.soap.response.SearchUserResult;
import com.wr.unit.admin.webservice.soap.response.base.IdResult;
...
@WebService(serviceName = "AccountService", endpointInterface = "com.wr.unit.admin.service.AccountEffectiveService", targetNamespace = WsConstants.NS)
